...
export default function PaymentMethod() {
    ...
    return (
        <div 
            ...
            className={`w-full md:w-1/2 p-4 gap-4 flex justify-between cursor-pointer border-2 transition-all ${checkedState ? 'border-primary' : 'border-border-color'}`} 
            style={{
                height: '4.75rem',
                borderRadius: 12,
            }}
        >
            <input 
                ...
                className='accent-primary self-start cursor-pointer' 
            />
